...
function init()
  ...
  self.help = 0 --This is to keep track of wether or not the NPC has called for backup
  self.random = math.random(1,8) --Chance to call for backup

  self.shouldDie = true
  self.forceDie = false
  self.pathing = {}
  
  status.addEphemeralEffect("shadowriftin", 1)
