...
function destroyRuin()
  ...
  player.radioMessage("tentaclemission-arrived2")
  player.radioMessage("tentaclemission-arrived3")
  ...
  player.radioMessage("tentaclemission-bottom2")
  player.radioMessage("tentaclemission-bottom3")
  ...
  player.radioMessage("tentaclemission-bossroom2")
